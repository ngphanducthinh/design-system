  ...
  render: () => ({
    setup: () => {
      const tokens = [
        ...
        { variable: '--b-menu-item-color', default: 'rgba(0,0,0,0.88)', description: 'Menu item text color' },
        { variable: '--b-menu-item-hover-bg', default: 'rgba(0,0,0,0.06)', description: 'Item background on hover' },
        { variable: '--b-menu-item-hover-color', default: 'rgba(0,0,0,0.88)', description: 'Item text color on hover' },
        { variable: '--b-menu-item-active-bg', default: '#e6f4ff', description: 'Item background when active' },
        { variable: '--b-menu-item-selected-bg', default: '#e6f4ff', description: 'Selected item background' },
        { variable: '--b-menu-item-selected-color', default: '#0958d9', description: 'Selected item text color' },
        { variable: '--b-menu-item-disabled-color', default: 'rgba(0,0,0,0.25)', description: 'Disabled item text color' },
        { variable: '--b-menu-item-height', default: '40px', description: 'Menu item height' },
        { variable: '--b-menu-item-border-radius', default: '8px', description: 'Menu item border radius' },
        { variable: '--b-menu-item-margin-block', default: '4px', description: 'Vertical margin between items' },
        { variable: '--b-menu-item-margin-inline', default: '4px', description: 'Horizontal margin of items' },
        { variable: '--b-menu-item-padding-inline', default: '16px', description: 'Horizontal padding inside items' },
        { variable: '--b-menu-icon-size', default: '14px', description: 'Icon size' },
        { variable: '--b-menu-icon-margin-inline-end', default: '10px', description: 'Spacing between icon and label' },
        { variable: '--b-menu-group-title-color', default: 'rgba(0,0,0,0.65)', description: 'Group title text color' },
        { variable: '--b-menu-group-title-font-size', default: '14px', description: 'Group title font size' },
        { variable: '--b-menu-group-title-line-height', default: '1.5714', description: 'Group title line height' },
        { variable: '--b-menu-danger-item-color', default: '#cf1322', description: 'Danger item text color' },
        { variable: '--b-menu-danger-item-hover-color', default: '#cf1322', description: 'Danger item hover color' },
        { variable: '--b-menu-danger-item-active-bg', default: '#fff2f0', description: 'Danger item active background' },
        { variable: '--b-menu-danger-item-selected-bg', default: '#fff2f0', description: 'Danger item selected background' },
        { variable: '--b-menu-danger-item-selected-color', default: '#cf1322', description: 'Danger item selected color' },
        { variable: '--b-menu-sub-menu-item-bg', default: 'rgba(0,0,0,0.02)', description: 'Submenu content background' },
        { variable: '--b-menu-sub-menu-item-border-radius', default: '4px', description: 'Submenu item border radius' },
        { variable: '--b-menu-sub-menu-item-selected-color', default: '#0958d9', description: 'Submenu title color when child selected' },
        { variable: '--b-menu-popup-bg', default: '#ffffff', description: 'Popup menu background' },
        { variable: '--b-menu-popup-shadow', default: '0 6px 16px ...', description: 'Popup box shadow' },
        { variable: '--b-menu-popup-border-radius', default: '8px', description: 'Popup border radius' },
        { variable: '--b-menu-popup-z-index', default: '1050', description: 'Popup z-index' },
        { variable: '--b-menu-dropdown-width', default: '160px', description: 'Popup menu min-width' },
        { variable: '--b-menu-collapsed-width', default: '80px', description: 'Menu width when collapsed' },
        { variable: '--b-menu-collapsed-icon-size', default: '16px', description: 'Icon size when collapsed' },
        { variable: '--b-menu-active-bar-height', default: '2px', description: 'Horizontal mode active indicator height' },
        { variable: '--b-menu-active-bar-width', default: '3px', description: 'Vertical mode active indicator width' },
        { variable: '--b-menu-horizontal-line-height', default: '46px', description: 'Horizontal menu item line height' },
        { variable: '--b-menu-horizontal-item-hover-bg', default: 'transparent', description: 'Horizontal item hover background' },
        { variable: '--b-menu-horizontal-item-hover-color', default: '#0958d9', description: 'Horizontal item hover color' },
        { variable: '--b-menu-horizontal-item-selected-bg', default: 'transparent', description: 'Horizontal item selected background' },
        { variable: '--b-menu-horizontal-item-selected-color', default: '#0958d9', description: 'Horizontal item selected color' },
        { variable: '--b-menu-horizontal-item-border-radius', default: '0', description: 'Horizontal item border radius' },
        { variable: '--b-menu-transition-duration', default: '200ms', description: 'Animation transition duration' },
      ];
      return { tokens };
    },
    template: `
