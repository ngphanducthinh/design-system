...
import { BInputStatus, BInputVariant, type BInputCountConfig, type BInputFocusOptions } from './types.ts';
  ...
  >
    ...
    <span class="b-input__wrapper">
      ...
      <span v-if="showPasswordToggle" class="b-input__password-toggle-wrapper">
        ...
        >
          <svg v-if="!passwordVisible" viewBox="64 64 896 896" width="1em" height="1em" fill="currentColor" aria-hidden="true">
